                ...
                <MDBCardBody>
                    ...
                    <MDBRow>
                        <form>
                            <MDBRow>
                                <MDBCol>
                                    ...
                                    <select class="form-control" name="type" id="type" required="">
                                        ...
                                        <option value="Correspondence Address" selected="">Correspondence Address</option>
                            ...
                            <MDBRow>
                                <MDBCol>
                                    <label class="required" for="details">Flat, House no., Building, Company, Apartment</label>
                                    <input class="form-control" type="text" name="details" id="details" value="" required="" />
                                </MDBCol>
                                <MDBCol>
                            ...
                            <MDBRow>
                                <MDBCol>
                                    ...
                                    <input class="form-control" type="text" name="landmark" id="landmark" value="" />
                                </MDBCol>
                                <MDBCol>
                                    <label class="required" for="locality">Locality</label>
                                    <input class="form-control" type="text" name="locality" id="locality" value="" required="" />
                                </MDBCol>
                            </MDBRow>

                            <MDBRow>
                                <MDBCol><label class="required" for="city">City/Town</label>
                                ...
                                <MDBCol>
                                    ...
                                    <input id="postal_code" class="form-control" type="text" name="postal_code" value="" required="" />
                                </MDBCol>
                            </MDBRow>

                            <MDBRow>
                                <MDBCol><label class="required" for="country_id">Country</label>
                            ...
                            <MDBRow>
                                ...
                                <MDBCol>
                                    <Link to='/stdaddress'><MDBBtn>Back</MDBBtn></Link>
                                </MDBCol>
                            </MDBRow>
                        </form>
                    </MDBRow>
